      ...
      <main className="flex w-full max-w-md min-h-screen flex-col items-center justify-between p-6">
        ...
        <div className="flex flex-col items-center gap-6 text-center w-full mb-auto">
          ...
          <p className="text-base leading-7 text-zinc-600 dark:text-zinc-400">
            Retrouvez votre groupe et vos discussions.
          </p>
        ...
        <div className="w-full flex flex-col gap-4 mt-8">
          <button
            ...
            className="w-full rounded-lg border border-transparent bg-[#152646] dark:bg-zinc-800 px-4 py-2.5 text-sm font-medium text-white cursor-pointer hover:opacity-90 outline-none focus:ring-2 focus:ring-black transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400 text-center">
            ...
            <a href="/front" className="text-[#426200] font-medium hover:underline">
              Créer un profil
            </a>
          </p>
