      ...
      <main className="flex w-full max-w-md min-h-screen flex-col items-center justify-between p-6">
        ...
        <div className="w-full flex flex-col gap-4 mt-8">
          <button
            ...
            className="w-full rounded-lg border border-transparent bg-[#152646] px-4 py-2.5 text-sm font-medium text-white cursor-pointer hover:opacity-90 outline-none focus:ring-2 focus:ring-black transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
