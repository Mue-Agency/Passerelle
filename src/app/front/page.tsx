...
export default function FrontPage() {
  ...
  setError("");
  setSuccess(`Bonjour, ${prenom.trim()} ${nom.trim()} !`);

  // Redirection vers votre dossier exact
      ...
      <main className="flex w-full max-w-md min-h-screen flex-col items-center justify-between p-6">
        ...
        <div className="w-full flex flex-col gap-4 mt-8">
          <button
            type="submit"
            form="profile-form"
            className="w-full rounded-lg border border-transparent bg-[#426200] dark:bg-zinc-800 px-4 py-2.5 text-sm font-medium text-white cursor-pointer hover:opacity-90 outline-none focus:ring-2 focus:ring-black transition"
          >
            Continuer
          </button>
