    ...
    <div className="flex flex-col min-h-screen items-center justify-center bg-[#FAF9F5] font-sans">
      <main className="flex w-full max-w-md min-h-screen flex-col items-center justify-between p-6">
        ...
        <div className="w-full flex items-center justify-center gap-3 mb-8">
          <svg xmlns="http://www.w3.org/2000/svg" width="41" height="41" viewBox="0 0 41 41" fill="none" className="shrink-0" aria-hidden="true">
          ...
          <p className="text-[28px] font-extrabold text-[#001A0E] leading-[36px] tracking-[-0.7px]">
            Alouette
          </p>
        </div>
        ...
        <div className="flex flex-col items-center gap-6 text-center w-full mb-auto">
          <h1 className="w-full text-3xl font-semibold leading-10 tracking-tight text-[#001A0E]">
            Inscription Admin
          </h1>

          <p className="text-base leading-7 text-[#424843]">
            Créez votre compte administrateur
          </p>

          <form id="register-form" onSubmit={handleSubmit} className="w-full flex flex-col gap-4 text-left">
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                className="w-full rounded-lg border border-zinc-200 bg-white px-4 py-2.5 text-sm text-[#001A0E] outline-none focus:ring-2 focus:ring-[#152646] transition"
              />
            </div>
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="secret" className="text-sm font-medium text-zinc-500">
                Secret d&apos;inscription
              </label>
              <input
                id="secret"
                type="password"
            ...
            <div className="text-xs text-zinc-500 text-center">
              Le secret vous est fourni par l&apos;équipe Alouette.
            </div>
        ...
        <div className="w-full flex flex-col gap-4 mt-8">
          <button
            ...
            form="register-form"
            disabled={loading}
            className="w-full rounded-lg border border-transparent bg-[#152646] px-4 py-2.5 text-sm font-medium text-white cursor-pointer hover:opacity-90 outline-none focus:ring-2 focus:ring-[#152646] transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
